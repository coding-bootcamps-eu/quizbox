...
const restartMultipleChoiceBtn = document.querySelector(
  "#restart-multiple-choice"
);
...
const multipleChoiceWrapper = document.querySelector(
...
function check() {
  field = document.querySelector('input[name="answer"]').parentElement
    .parentElement;
  answerCheckedParent = document.querySelector(
    'input[name="answer"]:checked'
  ).parentElement;
  answerChecked = document.querySelector(
    'input[name="answer"]:checked'
  ).className;
